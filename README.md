...
## Partie K8S
L'application sur proxmox doit être lancée manuellement. Copiez le fichier d'installation redis ``project-main/terraform/proxmox/install-redis.sh.tftpl`` dans la VM proxmox.
